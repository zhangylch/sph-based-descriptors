...
!f2py integer(kind=intype),intent(aux) :: numatom,length,cutnum,atomdim
...
!f2py integer(kind=intype),intent(aux) :: cutnum,atomdim
       do num=1,scutnum
...
!f2py integer(kind=intype),intent(aux) :: cutnum,maxnwave,atomdim
...
!f2py integer(kind=intype),intent(aux) :: cutnum,ipsin,totpara,atomdim
       tmp_vec(:,:,0)=1d0
       do m=1,ipsin
         do num=1,scutnum
           do k=1,atomdim
...
!f2py integer(kind=intype),intent(aux) :: totpara,cutnum,ipsin,atomdim
       tmp_vec(:,:,0)=1d0
       do m=1,ipsin
         do l=1,scutnum
           do k=1,atomdim
